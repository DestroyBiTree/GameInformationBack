...
public class BaseResponse {
    ...
    /**
     * 结果状态码(详见 com.promise.util.ResponseCode 状态信息配置类)
     */
    private int code;
    ...
    /**
     * @param code 结果状态码(详见 com.promise.util.ResponseCode 状态信息配置类)
    ...
    public static BaseResponse success(String message) {
        return new BaseResponse(ResponseCode.SUCCESS.getCode(), message);
    }
    ...
    public static BaseResponse error() {
        return BaseResponse.build(ResponseCode.FAIL, "");
    }

    public static BaseResponse error(String message) {
        return new BaseResponse(ResponseCode.FAIL.getCode(), message);
    }

    public static BaseResponse error(ResponseCode code) {
        return BaseResponse.build(code, "");
    }

    public static BaseResponse error(ResponseCode code, String message) {
